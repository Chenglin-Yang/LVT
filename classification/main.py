...
parser.add_argument('--cfg', type=str, default='./configs/210829_321.py')
...
def _parse_args():
    ...
    # save config
    import shutil
    args.output = os.path.join(args.output, args.cfg.split('/')[-1].split('.py')[0])
    os.makedirs(args.output, exist_ok=True)
    shutil.copyfile(
        args.cfg, os.path.join(args.output, args.cfg.split('/')[-1]),
    )
